...
## Animations
All images, GIFs, and artwork files in the `animations/` directory are licensed under the **Creative Commons Attribution-NoDerivatives 4.0 International (CC BY-ND 4.0)**.
See [animations/LICENSE](./animations/LICENSE) for details.
...
For questions about licensing, please open an issue.